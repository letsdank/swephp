...
class SweMPTab extends SweModule
{
    /*
    ...
    */
    ...
    static plantbl $plu404;

    static function initStatic()
    {
        self::$mer404 = new plantbl(
